...
/* harmony import */ var _modules_footer_accordion__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/footer-accordion */ "./js/modules/footer-accordion.js");
/* harmony import */ var _modules_footer_accordion__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_modules_footer_accordion__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _modules_change_text_in_main_block__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/change-text-in-main-block */ "./js/modules/change-text-in-main-block.js");
/* harmony import */ var _modules_change_text_in_main_block__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_modules_change_text_in_main_block__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _modules_main_block_scroll__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/main-block-scroll */ "./js/modules/main-block-scroll.js");
/* harmony import */ var _modules_main_block_scroll__WEBPACK_IMPORTED_MODULE_4___default = /*#__PURE__*/__webpack_require__.n(_modules_main_block_scroll__WEBPACK_IMPORTED_MODULE_4__);
/* harmony import */ var _modules_about_company_more_information__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/about-company-more-information */ "./js/modules/about-company-more-information.js");
/* harmony import */ var _modules_about_company_more_information__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_modules_about_company_more_information__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _modules_change_text_in_products_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/change-text-in-products-service */ "./js/modules/change-text-in-products-service.js");
/* harmony import */ var _modules_change_text_in_products_service__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(_modules_change_text_in_products_service__WEBPACK_IMPORTED_MODULE_6__);
/* harmony import */ var _modules_form_tel_mask__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/form-tel-mask */ "./js/modules/form-tel-mask.js");
/* harmony import */ var _modules_form_tel_mask__WEBPACK_IMPORTED_MODULE_7___default = /*#__PURE__*/__webpack_require__.n(_modules_form_tel_mask__WEBPACK_IMPORTED_MODULE_7__);
/* harmony import */ var _modules_modal_form_focus_on_name__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/modal-form-focus-on-name */ "./js/modules/modal-form-focus-on-name.js");
/* harmony import */ var _modules_modal_form_focus_on_name__WEBPACK_IMPORTED_MODULE_8___default = /*#__PURE__*/__webpack_require__.n(_modules_modal_form_focus_on_name__WEBPACK_IMPORTED_MODULE_8__);
...
/***/ "./js/modules/about-company-more-information.js":
/*!******************************************************!*\
  !*** ./js/modules/about-company-more-information.js ***!
  \******************************************************/
...
var aboutCompanyElement = document.querySelector('.about-company');
var aboutCompanyButtonMoreElement = document.querySelector('.about-company__button-more');
if (aboutCompanyElement && aboutCompanyButtonMoreElement) {
  var aboutCompanyParagraps = aboutCompanyElement.querySelectorAll('p[data-paragraph-display]');
  var _iterator = _createForOfIteratorHelper(aboutCompanyParagraps),
    _step;
  try {
  ...
  aboutCompanyButtonMoreElement.addEventListener('click', function () {
    var aboutCompanyButtonMoreStatus = document.querySelector('.about-company__button-more').getAttribute('data-more-status');
    if (aboutCompanyButtonMoreStatus === 'is-close') {
      var _iterator2 = _createForOfIteratorHelper(aboutCompanyParagraps),
        _step2;
      try {
    ...
    if (aboutCompanyButtonMoreStatus === 'is-open') {
      var _iterator3 = _createForOfIteratorHelper(aboutCompanyParagraps),
        _step3;
      try {
        for (_iterator3.s(); !(_step3 = _iterator3.n()).done;) {
          var _element = _step3.value;
          _element.setAttribute('data-paragraph-display', 'is-close');
...
/***/ "./js/modules/change-text-in-main-block.js":
/*!*************************************************!*\
  !*** ./js/modules/change-text-in-main-block.js ***!
  \*************************************************/
/*! no static exports found */
...
var mainBlockButtonElement = document.querySelector('.main-block__button');
var mainBlockButtonText = document.querySelector('.main-block__button-text');
var mainBlockMobileButtonText = document.querySelector('.main-block__mobile-button-text');
...
/***/ "./js/modules/change-text-in-products-service.js":
/*!*******************************************************!*\
  !*** ./js/modules/change-text-in-products-service.js ***!
  \*******************************************************/
/*! no static exports found */
...
var productsServiceTitleElement = document.querySelector('.products-service__title');
var productsServiceTitleText = document.querySelector('.products-service__title-text');
var productsServiceMobileTitleText = document.querySelector('.products-service__mobile-title-text');
...
var siteSectionListElement = document.querySelector('.site-sections__list');
var siteSectionsToggleElement = document.querySelector('.site-sections__toggle');
var contactsListElement = document.querySelector('.contacts__list');
var contactsToggleElement = document.querySelector('.contacts__toggle');
...
function siteSectionsListToggle() {
  var siteSectionsListStatus = siteSectionsToggleElement.getAttribute('data-list-status');
...
function contactsListToggle() {
  var contactsListStatus = contactsToggleElement.getAttribute('data-list-status');
...
/***/ "./js/modules/main-block-scroll.js":
/*!*****************************************!*\
  !*** ./js/modules/main-block-scroll.js ***!
  \*****************************************/
/*! no static exports found */
...
/***/ "./js/modules/modal-form-focus-on-name.js":
/*!************************************************!*\
  !*** ./js/modules/modal-form-focus-on-name.js ***!
  \************************************************/
/*! no static exports found */
...
var mainHeaderModalButtonElement = document.querySelector('.main-header__modal-button');
var modalTextInputElement = document.querySelector('input[name=modal-user-name]');
if (mainHeaderModalButtonElement && modalTextInputElement) {
  mainHeaderModalButtonElement.addEventListener('click', function () {
    setTimeout(function () {
      return modalTextInputElement.focus();
    }, 500);
  });
}
